...
public class Utils {
    private static final String PATH_ACTORES = "actores-test.txt";
    private static final String PATH_PELICULAS = "peliculas-test.txt";
    private static final String PATH_EDGES = "pelicula-actores-test.txt";
